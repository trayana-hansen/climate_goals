    ...
    <>
      <Section>
        <article className={styles.sectionOne}>
          ...
          <img className="divider" src={spacer1} alt="divider-one" />
        </article>
      </Section>
      ...
      <Section>
        ...
        <img className="divider" src={spacer2} alt="divider-two" />
		</article>
      </Section>
      <Section>
        ...
        <img className="divider" src={spacer3} alt="divider-three" />
		</article>
      </Section>
      <Section>
        ...
        <img className="divider" src={spacer4} alt="divider-four" />
		</article>
      </Section>
    </>
  );
